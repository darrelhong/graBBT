...
public class GraBBTDataInitSessionBean {
    ...
    private void initialiseData() {
        try {
            ...
            Listing lhStrawberryLatte = new Listing("Strawberry Latte", new BigDecimal(7.10), lihoStarVista,
            ...
            Listing lhAvocadoMilkCoffee = new Listing("Avocado Milk Coffee", new BigDecimal(6.10), lihoStarVista,
            ...
            Listing lhCheezHOMelonTea = new Listing("CheezHO Melon Tea", new BigDecimal(3.40), lihoStarVista,
            ...
            Listing lhStrawberryLatteOC = new Listing("Strawberry Latte", new BigDecimal(7.10), lihoOrchardGateway,
                    "lhstrawberrylatte.png", lhSizeOptions, lhSugarOptions, lhIceOptions, lhToppingOptions);
            listingSessionBean.createNewListing(lhStrawberryLatteOC);
            lihoOrchardGateway.getListings().add(lhStrawberryLatteOC);
            Listing lhAvocadoMilkCoffeeOC = new Listing("Avocado Milk Coffee", new BigDecimal(6.10), lihoOrchardGateway,
                    "lhavocadomilkcoffee.jpeg", lhSizeOptions, lhSugarOptions, lhIceOptions, lhToppingOptions);
            listingSessionBean.createNewListing(lhAvocadoMilkCoffeeOC);
            lihoOrchardGateway.getListings().add(lhAvocadoMilkCoffeeOC);
            Listing lhCheezHOMelonTeaOC = new Listing("CheezHO Melon Tea", new BigDecimal(3.40), lihoOrchardGateway,
                    "lhcheezhomelontea.jpeg", lhSizeOptions, lhSugarOptions, lhIceOptions, lhToppingOptions);
